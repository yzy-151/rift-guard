...
const UI_IDS = ["dialog_background", "dialog_frame", "dialog_name", "dialog_body", "dialog_continue", "dialog_auto", "dialog_history", "dialog_skip", "game_title", "game_subtitle", "squad_button", "pause_button", "restart_button", "hero_card_1", "hero_card_2", "hero_card_3", "menu_background", "menu_frame", "reward_title", "reward_card_1", "reward_card_2", "reward_card_3", "squad_background", "squad_frame", "squad_title", "squad_subtitle", "squad_confirm", "squad_character_1", "squad_character_2", "squad_character_3", "squad_character_4", "squad_character_5", "squad_character_6", "squad_character_7", "squad_character_8"]
var base_dir: String = ""
var path: String = ""
