...
const UI_IDS = ["dialog_background", "dialog_frame", "dialog_name", "dialog_body", "dialog_continue", "dialog_auto", "dialog_history", "dialog_skip", "game_title", "game_subtitle", "stage_button", "squad_button", "pause_button", "restart_button", "hero_card_1", "hero_card_2", "hero_card_3", "menu_background", "menu_frame", "reward_title", "reward_card_1", "reward_card_2", "reward_card_3", "squad_background", "squad_frame", "squad_title", "squad_subtitle", "squad_confirm", "squad_character_1", "squad_character_2", "squad_character_3", "squad_character_4", "squad_character_5", "squad_character_6", "squad_character_7", "squad_character_8", "squad_character_9", "squad_character_10", "squad_character_11", "squad_character_12", "stage_background", "stage_frame", "stage_title", "stage_card_1", "stage_card_2", "stage_card_3"]
var base_dir: String = ""
var path: String = ""
